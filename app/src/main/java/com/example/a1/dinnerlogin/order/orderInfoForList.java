...
public class orderInfoForList extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_orderinfoforlist);
        ...
        infoThread myThread=new infoThread(orderList.ord.getOrderid());
        ...
        mBack.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Intent intent=new Intent(orderInfoForList.this,menu.class);
            ...
            try{
                ...
                if(response.getStatusLine().getStatusCode()==200){
                    ...
                    if(entity!=null){
                        ...
                        msg4.setData(b4);
                        orderInfoForList.this.handler.sendMessage(msg4);
                    }
                }
            }catch(Exception e){
                e.printStackTrace();
