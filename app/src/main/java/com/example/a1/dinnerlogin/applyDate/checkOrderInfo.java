...
public class checkOrderInfo extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_checkorderinfo);
        ...
        infoThread myThread=new infoThread(msgMenu.ord.getOrderid());
        ...
        mBack.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                if (selected == 1){
                Intent intent=new Intent(checkOrderInfo.this,checkApply.class);
                startActivity(intent);
                finish();
                }else{
                    Intent intent=new Intent(checkOrderInfo.this,readApply.class);
                    startActivity(intent);
                    finish();
                }
            }
            ...
            try{
                ...
                if(response.getStatusLine().getStatusCode()==200){
                    ...
                    if(entity!=null){
                        ...
                        msg4.setData(b4);
                        checkOrderInfo.this.handler.sendMessage(msg4);
                    }
                }
            }catch(Exception e){
                e.printStackTrace();
