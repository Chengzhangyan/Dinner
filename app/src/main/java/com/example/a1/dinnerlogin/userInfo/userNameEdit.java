...
public class userNameEdit extends Activity {
    ...
    Handler handler = new Handler(){
        public void handleMessage(Message msg){
            ...
            if (b.getString("flag").equals("true")){/*若flag为true则登陆成功*/
                Toast.makeText(userNameEdit.this,"修改昵称成功！",Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(userNameEdit.this,menu.class);
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        mReturnButton = (Button)findViewById(R.id.name_edit_cansel_btn);
        mSureButton = (Button)findViewById(R.id.name_edit_sure_btn);
    ...
    View.OnClickListener mListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            Intent this_to_info = new Intent(userNameEdit.this,menu.class);
            this_to_info.putExtra("object",4);
            switch (v.getId()) {
                case R.id.name_edit_sure_btn:
                    if(isNameValid()){
                        editName();}
                    break;
                case R.id.name_edit_cansel_btn:
                    Toast.makeText(userNameEdit.this,getString(R.string.back),Toast.LENGTH_SHORT).show();
    ...
    public void editName(){
        ...
        String name = mName.getText().toString().trim();/*获得当前输入的新昵称*/
    ...
    class NameThread implements Runnable{
        ...
        public NameThread(String userid,String nickname){
            this.userid = userid;
                ...
                if (response.getStatusLine().getStatusCode()==200){/*返回码为200则连接成功*/
                    ...
                    if (entity!=null){
                     ...
                     //   b.putString("nickname",jsonData.getString("nickname"));
                       ...
                       // System.out.println("newname is "+jsonData.getString("nickname"));
                        Message msg = new Message();
                        msg.setData(b);/*向消息中放入b对象，这样可以发送到别的类*/
                        userNameEdit.this.handler.sendMessage(msg);
                    }
                }
            }catch(Exception e){
                e.printStackTrace();
