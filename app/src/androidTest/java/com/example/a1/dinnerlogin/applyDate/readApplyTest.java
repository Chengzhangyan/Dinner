 ...
 */
public class readApplyTest extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    public readApplyTest(){
        super(readApply.class);
    }
    ...
    public void testMain()throws  Exception{
        ...
        boolean result2 = solo.searchButton("nickname");solo.searchButton("查看饭约信息");
