 ...
 */
public class userAddressEditTest extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    public userAddressEditTest(){
        super(userAddressEdit.class);
    }
    ...
    public void testMain()throws  Exception{
        ...
        boolean result1 = solo.searchText("修改地区");
        ...
        Button Button1 = (Button) solo.getView(R.id.area_edit_cansel_btn);
