 ...
 */
public class userSchoolEditTest extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    public userSchoolEditTest(){
        super(userSchoolEdit.class);
    }
    @Override
    ...
    public void testMain()throws  Exception{
        ...
        Button Button1 = (Button) solo.getView(R.id.school_edit_cansel_btn);
